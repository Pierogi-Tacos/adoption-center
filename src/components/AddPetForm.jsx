...
const AddPetForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        e.preventDefault();
        axios.post("https://api-pets.adaptable.app/pets", newPet)
        .then((result) => {
          console.log(result)
        })
        .catch((error) => {
...
/>
    ...
    <select name="vaccination" value={newPet.vaccination} onChange={handleChange} /* required */>
    ...
    <select name="size" value={newPet.size} onChange={handleChange} /* required */>
    <option value="" disabled  ></option>    
    ...
    <select name="likes_kids" value={newPet.likes_kids} onChange={handleChange} /*/* required */> 
        <option value={""} disabled ></option>    
        <option value={true} >Yes</option>    
        <option value={false}>No</option>    
    </select> 
